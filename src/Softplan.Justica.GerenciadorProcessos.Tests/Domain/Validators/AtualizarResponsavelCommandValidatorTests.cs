...
{
    public class AtualizarResponsavelCommandValidatorTests : ValidatorTestDataBase
    {
        private AtualizarResponsavelCommandValidator sut;
        public Mock<INotificationContext> mockNotificationContext;
        private List<Notification> notifications;

        public AtualizarResponsavelCommandValidatorTests()
        {
            ...
            this.sut = new AtualizarResponsavelCommandValidator(this.MockResponsavelRepository.Object, this.mockNotificationContext.Object);
        }
        ...
        public async void ValidarFalhaResponsavelNaoEncontrado()
        {
            ...
            // Assert
            result.Should().BeFalse();
            this.notifications.FirstOrDefault(notifications => notifications.Message == ErrorMessages.ResponsavelNaoEncontrado).Should().NotBeNull();
        }
        ...
        public async void ValidarFalhaCpfEmUso()
        {
            ...
            this.MockResponsavelRepository
                .Setup(rp => rp.Obter(It.IsNotNull<Expression<Func<Responsavel, bool>>>()))
                .Returns(new List<Responsavel> { this.Kelvin });
